...
const BASE =
  'relative inline-flex cursor-pointer items-center gap-2 overflow-hidden rounded-[0.25rem] text-left font-mono font-medium uppercase transition-[filter_0.2s_ease,transform_0.15s_ease,box-shadow_0.2s_ease]'
