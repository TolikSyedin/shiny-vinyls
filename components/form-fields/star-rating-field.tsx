        ...
        {STARS.map((n) => {
          ...
          return (
            <label
              ...
              className="cursor-pointer rounded-[var(--radius)] has-[:focus-visible]:outline-[0.1rem] has-[:focus-visible]:-outline-offset-2 has-[:focus-visible]:outline-[var(--stamp)]"
            >
              <input
                id={id}
                type="radio"
